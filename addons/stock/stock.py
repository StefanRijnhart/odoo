...
class stock_quant(osv.osv):
    ...
    def quants_reserve(self, cr, uid, quants, move, link=False, context=None):
        ...
        tracking = move.product_id.track_outgoing or move.product_id.track_all
        for quant, qty in quants:
            if tracking and float_compare(move.availability, 0, precision_rounding=rounding) < 1:
                continue
            ...
            if tracking and float_compare(move.availability, qty, precision_rounding=rounding) == -1:
